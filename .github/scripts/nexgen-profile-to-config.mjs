...
function convertXboardToNexgen(xboard) {
  ...
  const converted = {
    ...
    ui: {
      ...
      hide_plan_speed: boolOrUndefined(ui.hide_plan_speed ?? ui.hidePlanSpeed),
...
function getSettingsOverride(config) {
  ...
  normalizeAlias(settings, "autoTestAfterLogin", "auto_test_after_login");
  ...
  settings.auto_test_after_login = typeof settings.auto_test_after_login === "boolean" ? settings.auto_test_after_login : false;
  ...
  delete settings.autoTestAfterLogin;
